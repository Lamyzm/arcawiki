...
| 업스케일 모델 | `https://huggingface.co/Kim2091/2x-AnimeSharpV4/resolve/main/2x-AnimeSharpV4_Fast_RCAN_PU.safetensors` 를 받아 `models/upscale_models` 에 넣고 **F5 새로고침 또는 ComfyUI 재시작** |
